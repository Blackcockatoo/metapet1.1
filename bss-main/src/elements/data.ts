 ...
 * Minimal dataset: atomic number, symbol, name
 */
 ...
 */
export const ELEMENT_BY_Z: Map<number, ElementData> = new Map(
  ELEMENT_DATA.map((e) => [e.z, e])
);

/**
 * Fast lookup by symbol
 */
export const ELEMENT_BY_SYMBOL: Map<string, ElementData> = new Map(
  ELEMENT_DATA.map((e) => [e.symbol, e])
);
